 ...
 *
 */
public class Toma_LSQ_bk extends SimulationElement {
	...
	public Toma_LSQ_bk(PortType portType, int noOfPorts, long occupancy, long latency, CoreMemorySystem containingMemSys, int lsqSize) {
